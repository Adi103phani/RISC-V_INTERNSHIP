...
Simulation and Optimization:  I ran simulations using the SPIKE simulator with different optimization levels (-O1 and -Ofast) to analyze performance variations.

Code Development and Compilation:  I wrote a simple C program and compiled it using a RISC-V GCC compiler specifically designed for the RISC-V architecture.
